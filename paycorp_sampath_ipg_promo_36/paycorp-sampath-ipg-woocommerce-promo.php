...
/*
Plugin Name: Paycorp Sampath Bank IPG PROMO 36
License URI: https://www.paycorp.lk/
Description: Sampath IPG by Paycorp 36 Month.
...
add_action('plugins_loaded', 'woocommerce_sampath_bank_promo_36_gateway', 0);


function woocommerce_sampath_bank_promo_36_gateway()
{


     if (!class_exists('WC_Payment_Gateway')) return;

    class WC_Sampath_promo_36 extends WC_Payment_Gateway
    {
        public function __construct()
        {
            ...
            $this->id = 'sampathipgpromo_36';
            $this->method_title = 'Paycorp Sampath Promo 36';
        ...
        public function init_form_fields()
        {
            ...
            $this->form_fields = array(
                ...
                'title' => array(
                    'title' => __('Title:', 'paycorp promo_36'),
                    'type' => 'text',
    ...
    if (isset($_POST['clientRef']) && isset($_POST['reqid'])) {
        $WC = new WC_Sampath_promo_36();
    }


    function woocommerce_add_sampath_promo_36_gateway($methods)
    {
        $methods[] = 'WC_Sampath_promo_36';
        return $methods;
    }

    add_filter('woocommerce_payment_gateways', 'woocommerce_add_sampath_promo_36_gateway');



    add_shortcode('paycorp_sampath_ipg_promo_36_dispaly_error_msg', 'paycorp_sampath_promo_36_dispaly_error_message');

    function paycorp_sampath_promo_36_dispaly_success_message()
    {
    ...
    add_shortcode('paycorp_sampath_ipg_promo_36_dispaly_success_msg', 'paycorp_sampath_promo_36_dispaly_success_message');
