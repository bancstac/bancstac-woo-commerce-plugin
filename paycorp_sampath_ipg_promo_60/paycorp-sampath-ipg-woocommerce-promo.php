...
/*
Plugin Name: Paycorp Sampath Bank IPG PROMO 60
License URI: https://www.paycorp.lk/
Description: Sampath IPG by Paycorp 60 Month.
Version: 1.8.6.8 - woocommerce 6.8.2
Promo 60
...
add_action('plugins_loaded', 'woocommerce_sampath_bank_promo_60_gateway', 0);


function woocommerce_sampath_bank_promo_60_gateway()
{


     if (!class_exists('WC_Payment_Gateway')) return;

    class WC_Sampath_promo_60 extends WC_Payment_Gateway
    {
        public function __construct()
        {
            ...
            $this->id = 'sampathipgpromo_60';
            $this->method_title = 'Paycorp Sampath Promo 60';
            ...
            $this->gateway_config();
            if ( version_compare( WC()->version, '6.9', '<' )) {
        ...
        public function init_form_fields()
        {
            ...
            $this->form_fields = array(
                ...
                'title' => array(
                    'title' => __('Title:', 'paycorp promo_60'),
                    'type' => 'text',
    ...
    if (isset($_POST['clientRef']) && isset($_POST['reqid'])) {
        $WC = new WC_Sampath_promo_60();
    }


    function woocommerce_add_sampath_promo_60_gateway($methods)
    {
        $methods[] = 'WC_Sampath_promo_60';
        return $methods;
    }

    add_filter('woocommerce_payment_gateways', 'woocommerce_add_sampath_promo_60_gateway');



    add_shortcode('paycorp_sampath_ipg_promo_60_dispaly_error_msg', 'paycorp_sampath_promo_60_dispaly_error_message');

    function paycorp_sampath_promo_60_dispaly_success_message()
    {
    ...
    add_shortcode('paycorp_sampath_ipg_promo_60_dispaly_success_msg', 'paycorp_sampath_promo_60_dispaly_success_message');
